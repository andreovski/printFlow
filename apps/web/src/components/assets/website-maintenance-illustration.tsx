...
export function WebsiteMaintenanceIllustration({ className }: { className?: string }) {
  return (
    <svg
    ...
    >
      <g style={{ opacity: 0.1 }}>
        <path
          ...
          className="animate-spin-slow fill-primary"
        ></path>
        <path
          ...
          className="animate-spin-reverse-slow fill-primary"
        ></path>
      </g>
      <ellipse
        cx="914"
      ...
      <path
        ...
        style={{ fill: '#0b4870' }}
      ></path>
      <path d="m860.7 360-15.1 46.2 27.3 5.4 6-47.9z" style={{ fill: '#fcd2b1' }}></path>
      <path
      ...
      <path
        ...
        style={{ fill: '#f7f7f7' }}
      ></path>
      <path d="M867.2 529.7H905v3.2h-37.8z" style={{ opacity: 0.32, fill: '#161616' }}></path>
      <path

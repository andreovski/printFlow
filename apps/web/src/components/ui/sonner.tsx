  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            'group toast group-[.toaster]:bg-background/50 group-[.toaster]:backdrop-blur group-[.toaster]:text-foreground group-[.toaster]:border-border group-[.toaster]:shadow-lg',

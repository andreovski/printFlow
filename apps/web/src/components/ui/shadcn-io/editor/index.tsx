...
const EditorToolbar = () => {
  ...
  return (
    <div className="border-b flex items-center gap-1 flex-wrap bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-1">
      <Button
        type="button"
  ...
  return (
    <TooltipProvider>
      <div
        className={cn(
          className,
          '[&_.ProseMirror-focused]:outline-none p-2 flex flex-col gap-2 mb-6'
        )}
      >
